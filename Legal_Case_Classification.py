...
def prepare_test_data(input_folder):
    ...
    test_folder = list_files_from_directory("test")
    t_sentences = []
    t_categories = []
...
all_files = get_file_list_from_dir("train")
for files in all_files:
    get_all_classes_and_labels_from_testing(files)
    #print(files)
    
create_text_label_array()
categories, sentences = prepare_test_data("test")
